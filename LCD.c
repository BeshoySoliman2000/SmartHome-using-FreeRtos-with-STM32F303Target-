...
{
	GPIO_voidSetPinDir(LCD_PORT, RS, OUTPUTdir);
	GPIO_voidSetPinDir(LCD_PORT, EN, OUTPUTdir);
	GPIO_voidSetPinDir(LCD_PORT, D4, OUTPUTdir);
	GPIO_voidSetPinDir(LCD_PORT, D5, OUTPUTdir);
	GPIO_voidSetPinDir(LCD_PORT, D6, OUTPUTdir);
	GPIO_voidSetPinDir(LCD_PORT, D7, OUTPUTdir);
	...
	GPIO_voidSetPinVal(LCD_PORT, EN, GPIOx_High);
	...
	GPIO_voidSetPinVal(LCD_PORT, D7, GET_BIT(FunctionSet2_Command,7));
	GPIO_voidSetPinVal(LCD_PORT, D6, GET_BIT(FunctionSet2_Command,6));
	GPIO_voidSetPinVal(LCD_PORT, D5, GET_BIT(FunctionSet2_Command,5));
	GPIO_voidSetPinVal(LCD_PORT, D4, GET_BIT(FunctionSet2_Command,4));
	
	GPIO_voidSetPinVal(LCD_PORT, EN, GPIOx_LOW);
...
void LCD_voidSendCommand(u8 Copy_u8Command)
{
	...
	GPIO_voidSetPinVal(LCD_PORT, RS, GPIOx_LOW);
	LCD_voidSendDataBus(Copy_u8Command);
}
void LCD_voidSendData(u8 Copy_u8Data)
{
	//DIO_enum_WriteChannel(RS, DIO_u8High);
	GPIO_voidSetPinVal(LCD_PORT, RS, GPIOx_High);
...
void LCD_voidSendDataBus(u8 Copy_u8BUS)
{
	...
	GPIO_voidSetPinVal(LCD_PORT, D7, GET_BIT(Copy_u8BUS,7));
	GPIO_voidSetPinVal(LCD_PORT, D6, GET_BIT(Copy_u8BUS,6));
	GPIO_voidSetPinVal(LCD_PORT, D5, GET_BIT(Copy_u8BUS,5));
	GPIO_voidSetPinVal(LCD_PORT, D4, GET_BIT(Copy_u8BUS,4));
	...
	GPIO_voidSetPinVal(LCD_PORT, D7, GET_BIT(Copy_u8BUS,3));
	GPIO_voidSetPinVal(LCD_PORT, D6, GET_BIT(Copy_u8BUS,2));
	GPIO_voidSetPinVal(LCD_PORT, D5, GET_BIT(Copy_u8BUS,1));
	GPIO_voidSetPinVal(LCD_PORT, D4, GET_BIT(Copy_u8BUS,0));
